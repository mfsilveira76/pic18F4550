...
void testarDisplay2(void){
    ...
    do{
        ...
        {
            Escreve7Seg(1, milhar, 0); _delay((unsigned long)((18)*(8000000/4000.0)));
            Escreve7Seg(2, centena,0); _delay((unsigned long)((18)*(8000000/4000.0)));
            Escreve7Seg(3, dezena ,0); _delay((unsigned long)((18)*(8000000/4000.0)));
            Escreve7Seg(4, unidade,0); _delay((unsigned long)((18)*(8000000/4000.0)));
            PORTAbits.RA5 = 0;
...
void testarCoolerPot(unsigned char pot){
    ...
    while(1){
        ...
        t = 0;
        while(t < 2){
            Escreve7Seg(4, DD4, 0); _delay((unsigned long)((4)*(8000000/4000.0)));
            Escreve7Seg(3, DD3, 0); _delay((unsigned long)((4)*(8000000/4000.0)));
            Escreve7Seg(2, DD2, 0); _delay((unsigned long)((4)*(8000000/4000.0)));
            Escreve7Seg(1, DD1, 0); _delay((unsigned long)((4)*(8000000/4000.0)));
            t = t+1;
        }
        if (PORTBbits.RB1 == 0){
            while(PORTBbits.RB1 == 0 );;
...
void testarCoolerPotUpDown(void){
    ...
    while(1){
        ...
        t = 0;
        while(t < 2){
            Escreve7Seg(4, DD4, 1); _delay((unsigned long)((8)*(8000000/4000.0)));
            Escreve7Seg(3, DD3, 0); _delay((unsigned long)((8)*(8000000/4000.0)));
            Escreve7Seg(2, DD2, 0); _delay((unsigned long)((8)*(8000000/4000.0)));
            Escreve7Seg(1, DD1, 0); _delay((unsigned long)((8)*(8000000/4000.0)));
            Escreve7Seg(7, 0, 0);
            t = t+1;
        }
        if (vlrUpDown >0 && PORTBbits.RB0 ==0 ){
            while(PORTBbits.RB0 == 0 );
            vlrUpDown--;
        }else if (vlrUpDown <100 && PORTBbits.RB2 == 0){
            while(PORTBbits.RB2 == 0 );
            vlrUpDown++;
        }
        if (PORTBbits.RB1 == 0){
...
void miniMidi(void){
    ...
    unsigned int notas [] ={
                            784,125000,784,125000,784,125000,659,125000,987,125000,784,125000,659,125000,987,125000,784,125000,622 *2,125000,622 *2,125000,
                            622 *2,125000,659*2,125000,987,125000,740,125000,659,125000,987,125000,784,125000,830 *2,125000,784,125000,784,125000,830 *2,125000,
                            784*2,125000,740 *2,125000,698*2,125000,659*2,125000,740 *2,125000
                            };
...
short capturaUpDown(short opt){
    ...
    if(PORTBbits.RB0 == 0 ){
        opt++; while(PORTBbits.RB0 == 0 );
    } else if(PORTBbits.RB2 == 0){
       opt--; while(PORTBbits.RB2 == 0 );
    }
    ...
    while (1){
        ...
        switch(vopc){
            ...
            case 4:
                 ...
                 EscreveLinhaLCD4(2, " PWM 100% Off   ");
                  if (PORTBbits.RB1 == 0 ){
                     while(PORTBbits.RB1 == 0 );
                     testarBuzzerPWM(75);
                 }
...
short subMenuLCD(void){
    ...
    while (1){
        ...
        switch(vopc){
            case 1:
                EscreveLinhaLCD4(1, ">Iniciar Teste  ");
                EscreveLinhaLCD4(2, " Voltar         ");
                if (PORTBbits.RB1 == 0){
                    while(PORTBbits.RB1 == 0 );
                   testarLCD();
...
short subMenuCooler (void){
    ...
    while (1){
        ...
        switch(vopc){
            case 1:
                EscreveLinhaLCD4(1, ">Potenciometro 1");
...
void main(void) {
    ...
    EscreveLinhaLCD4(1, "   ELETRONICA   ");
    EscreveLinhaLCD4(2, "   IFRS         ");
    Delay_ms(700);

    EscreveLinhaLCD4(1, " BEM VINDO AO    ");
...
void ConfiguraLCD4(unsigned char INST){
    PORTEbits.RE2 = 0;
    PORTD = (PORTD & 0x0f)|(0xF0 & INST);
    PORTEbits.RE1 = 1;
    _delay((unsigned long)((10)*(8000000/4000000.0)));
    PORTEbits.RE1 = 0;
        _delay((unsigned long)((5)*(8000000/4000.0)));
    PORTD = (PORTD & 0x0f)|(INST<<4);
    PORTEbits.RE1 = 1;
    _delay((unsigned long)((10)*(8000000/4000000.0)));
    PORTEbits.RE1 = 0;
    _delay((unsigned long)((5)*(8000000/4000.0)));
...
void EscreveLCD4(unsigned char DADO){
    PORTEbits.RE2 = 1;
    PORTD = (PORTD & 0x0f)|(0xF0 & DADO);
    PORTEbits.RE1 = 1;
    _delay((unsigned long)((10)*(8000000/4000000.0)));
    PORTEbits.RE1 = 0;
    _delay((unsigned long)((100)*(8000000/4000000.0)));
    PORTD = (PORTD & 0x0f)|(DADO<<4);
    PORTEbits.RE1 = 1;
    _delay((unsigned long)((10)*(8000000/4000000.0)));
    PORTEbits.RE1 = 0;
    _delay((unsigned long)((100)*(8000000/4000000.0)));
...
void Escreve7Seg(unsigned char DISPLAY, unsigned char DADO, unsigned char PONTO){
    ...
    switch(DISPLAY){
        case 1: PORTAbits.RA2 = 1; PORTAbits.RA3 = 0; PORTAbits.RA4 = 0; PORTAbits.RA5 = 0; break;
        case 2: PORTAbits.RA2 = 0; PORTAbits.RA3 = 1; PORTAbits.RA4 = 0; PORTAbits.RA5 = 0; break;
        case 3: PORTAbits.RA2 = 0; PORTAbits.RA3 = 0; PORTAbits.RA4 = 1; PORTAbits.RA5 = 0; break;
        case 4: PORTAbits.RA2 = 0; PORTAbits.RA3 = 0; PORTAbits.RA4 = 0; PORTAbits.RA5 = 1; break;

        default: PORTAbits.RA2 = 0; PORTAbits.RA3 = 0; PORTAbits.RA4 = 0; PORTAbits.RA5 = 0;
    }
    ...
    switch(DADO){
        ...
        case 254:PORTD = 0b00111001; break;
        case 255:PORTD = 0b01100011; break;
